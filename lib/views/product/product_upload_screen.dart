...
class ProductCreationScreen extends GetView<ProductController> {
  ...
  //     if (controller.subCategoryController.text.isNotEmpty &&
  //         !subCategories.any((subCat) => subCat.sId == controller.subCategoryController.text)) {
  //       controller.subCategoryController.text = subCategories.first.sId!; // Clear the selected subcategory
  //       categoryController.selectedSubCategory.value = subCategories.first; // Reset selected subcategory
  //     }
  //
  //     return DropdownButtonFormField<String>(
  //       decoration: InputDecoration(
...
//                               image: controller
//                                       .mediaController.imageBase64.isNotEmpty
//                                   ? DecorationImage(
//                                       image: MemoryImage(base64Decode(controller
//                                           .mediaController.imageBase64
//                                           .split(',')
...
//                             ),
//                             child:
//                                 controller.mediaController.imageBase64.isEmpty
//                                     ? const Icon(FontAwesomeIcons.image,
//                                         color: Colors.deepPurple, size: 40)
//                                     : null,
//                           ),
...
//                         children: List.generate(3, (index) {
//                           if (index <
//                               controller.mediaController.additionalImagesBase64
//                                   .length) {
//                             return GestureDetector(
//                               onDoubleTap: () {
//                                 controller.mediaController.removeImage(index);
...
//                                   image: DecorationImage(
//                                     image: MemoryImage(base64Decode(controller.mediaController.additionalImagesBase64[index].split(',').last)),
//                                     fit: BoxFit.cover,
//                                   ),
//                                 ),
//                               ),
...
//                         : () async {
//                             await controller
//                                 .createProduct((onCreate, {errorMessage}) {
//                               if (onCreate == true) {
