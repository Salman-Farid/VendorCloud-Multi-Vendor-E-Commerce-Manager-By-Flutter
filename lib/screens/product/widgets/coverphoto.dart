                ...
                child: Obx(() {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: imageBase64.isNotEmpty ? DecorationImage(image: MemoryImage(base64Decode(imageBase64.split(',').last)), fit: BoxFit.cover,) : imageUrl.isNotEmpty ? DecorationImage(
