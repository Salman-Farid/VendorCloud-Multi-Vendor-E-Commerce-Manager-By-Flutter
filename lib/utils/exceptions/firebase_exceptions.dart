...
class CustomApiException implements Exception {
  ...
  String get message {
    switch (code) {
      ...
      case 'invalid-token':
        return 'The provided token is invalid. Please login again.';
      case 'token-expired':
        return 'The session has expired. Please login again.';
      case 'user-disabled':
        return 'The user account has been disabled. Contact support for help.';
      case 'user-not-found':
      ...
      case 'weak-password':
        return 'The password is too weak. Please choose a stronger password.';
      case 'account-locked':
        return 'The account is locked due to multiple failed login attempts. Try again later.';
      case 'operation-not-allowed':
        return 'This operation is not allowed. Please contact support.';
      case 'invalid-otp':
        return 'The OTP is invalid. Please enter the correct OTP.';
      case 'otp-expired':
      ...
      case 'invalid-request':
        return 'The request is invalid. Please check the input and try again.';
      case 'unauthorized':
        return 'You are not authorized to perform this action.';
      case 'forbidden':
        return 'Access is forbidden. You do not have permission for this resource.';
      ...
      case 'conflict':
        return 'The request could not be processed due to a conflict. Please check and try again.';
      default:
